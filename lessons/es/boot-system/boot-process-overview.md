...
:::single-choice{#boot-overview-first-stage} ¿Qué componente comienza la inicialización de la plataforma después del reinicio en un PC típico?
...
:::single-choice{#boot-overview-loader-role} ¿Cuál es una responsabilidad habitual de un cargador de arranque de Linux?
...
:::single-choice{#boot-overview-initramfs-purpose} ¿Por qué puede utilizar un sistema un initramfs?
...
:::single-choice{#boot-overview-final-stage} ¿Qué comienza la etapa principal de inicialización del espacio de usuario?
