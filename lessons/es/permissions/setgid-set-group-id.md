...
:::single-choice{#setgid-executable-effect} Cuando se respeta setgid en un ejecutable, ¿qué credencial procede del grupo propietario del ejecutable?
...
:::single-choice{#setgid-directory-inheritance} ¿Qué hace normalmente que un archivo nuevo herede setgid en `/srv/project`?
...
:::single-choice{#setgid-octal-value} ¿Qué valor aporta setgid al dígito octal inicial de bits especiales?
...
:::single-choice{#setgid-directory-write-access} ¿Establecer setgid por sí solo permite a los miembros del grupo crear archivos en un directorio?
