...
¿Qué es un perfil de conexión de NetworkManager?
...
¿Qué comando lista los perfiles activos de NetworkManager?
...
¿Cuál es la diferencia entre `connection modify` y `connection up`?
...
¿Qué demuestra más que el estado «conectado» de NetworkManager?
