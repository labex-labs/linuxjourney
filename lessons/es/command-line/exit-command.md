...
Has iniciado Bash dentro de otra shell y quieres volver a la shell padre. ¿Qué orden debes ejecutar en la sesión anidada de Bash?
...
¿Qué orden termina la shell actual e informa explícitamente de un resultado satisfactorio a quien la invocó?
...
En Bash, ¿qué estado devuelve `exit` cuando no se proporciona ningún número?
...
¿Qué orden integrada de Bash está pensada específicamente para salir de una shell de inicio de sesión?
