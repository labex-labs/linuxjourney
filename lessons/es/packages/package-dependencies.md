...
¿Qué intenta producir un solucionador de dependencias que conoce los repositorios?
...
¿Por qué puede fallar un programa aunque exista un archivo de biblioteca con un nombre parecido?
...
¿Cuál es una limitación habitual de instalar un paquete local con una herramienta de archivos de bajo nivel?
