...
¿Qué debes verificar después de instalar `sysstat`?
...
¿Qué opción indica a `sar` que lea un archivo de actividad determinado?
...
¿Cómo deben utilizarse los datos históricos de `sar` al revisar un incidente?
