...
¿Qué subárbol de sysfs contiene la jerarquía principal de dispositivos del kernel?
...
¿Qué contiene normalmente el atributo `dev` de sysfs de un dispositivo de bloques?
...
¿Qué afirmación distingue correctamente `/sys` de `/dev`?
...
¿Por qué puede ser importante para el funcionamiento escribir en un atributo de sysfs?
