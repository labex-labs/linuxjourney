...
¿Qué muestra `head events.log` de forma predeterminada?
...
¿Qué orden muestra las primeras cinco líneas de `report.txt`?
...
¿Qué orden escribe en stdout los primeros 100 bytes de `payload.bin`?
...
En `generate-report | head -n 5`, ¿qué lee `head`?
...
¿Qué opción suprime los encabezados de nombre de archivo cuando `head` lee varios archivos?
