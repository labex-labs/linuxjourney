...
:::single-choice{#package-management-systems-apt-show} 哪个命令显示 `package-name` 的 APT 软件包详情？
...
:::single-choice{#package-management-systems-dnf-install} 当前哪个命令从已配置 RPM 家族仓库安装 `package-name`？
...
:::single-choice{#package-management-systems-remove-review} 为什么确认前应该审查移除事务？
...
:::single-choice{#package-management-systems-apt-update-upgrade} `apt update` 与 `apt upgrade` 有什么关系？
...
:::single-choice{#package-management-systems-yum-current-rhel} 在当前 RHEL 系统上，`yum` 通常表示什么？
