...
:::single-choice{#link-layer-fcs-purpose} 以太网帧校验序列有什么用途？
...
:::single-choice{#link-layer-switch-learning} 以太网交换机通常会从帧中学习什么信息？
...
:::single-choice{#link-layer-remote-destination-mac} 对于不在链路上的 IPv4 目标，主机使用哪个 MAC 地址？
...
:::single-choice{#link-layer-stale-neighbor} `STALE` 邻居条目表示什么？
...
:::single-choice{#link-layer-router-reframing} 普通转发过程中，以太网帧在路由器处改变时，什么保持不变？
