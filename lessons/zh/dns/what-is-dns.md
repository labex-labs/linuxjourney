...
:::single-choice{#dns-purpose-beyond-address} 为什么说 DNS 不只是主机名到地址的列表？
...
:::single-choice{#dns-trailing-dot} `www.example.com.` 末尾的点表示什么？
...
:::single-choice{#dns-authoritative-data} 谁为一个受委派的 DNS 区域提供最终数据？
...
:::single-choice{#dns-cache-ttl-role} DNS 记录的 TTL 主要控制什么？
