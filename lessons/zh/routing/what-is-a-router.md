...
:::single-choice{#router-forwarding-role} 数据包转发会做什么？
...
:::single-choice{#router-default-route} 什么时候会选择默认路由？
...
:::single-choice{#router-same-subnet-path} 两台链路内主机之间的流量必须经过默认路由器吗？
...
:::single-choice{#router-hop-count-limit} 较少的跳数无法保证什么？
