...
:::single-choice{#sysv-overview-detection} 什么是 sysvinit 正在活动的最有力证据？
...
:::single-choice{#sysv-overview-shutdown-runlevel} 在许多 SysV 系统上，哪个运行级别传统上请求关机或断电？
...
:::single-choice{#sysv-overview-start-link} 进入运行级别时，`S20networking` 链接传统上请求什么？
...
:::single-choice{#sysv-overview-runlevel-six-meaning} 运行级别 `6` 传统上请求什么？
...
:::single-choice{#sysv-overview-compatibility-script} 为什么 systemd 主机上的 SysV 风格脚本通常应该通过服务管理器调用？
