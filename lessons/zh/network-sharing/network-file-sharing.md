...
:::single-choice{#file-sharing-one-time-ssh-copy} 哪个工具适合通过 SSH 一次性复制文件？
...
:::single-choice{#file-sharing-scp-pull-source} 在 `scp` 拉取操作中，远程说明位于哪里？
...
:::single-choice{#file-sharing-scp-recursive} `scp -r` 请求什么？
...
:::single-choice{#file-sharing-host-key-change} SSH 报告主机密钥意外改变时应该怎么做？
