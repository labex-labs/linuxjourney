...
:::single-choice{#match-gentoo-user} 哪类用户最适合 Gentoo？
...
:::single-choice{#identify-portage-role} Portage 在 Gentoo 中发挥什么作用？
...
:::single-choice{#explain-use-flags} Gentoo 的 USE 标志控制什么？
...
:::single-choice{#recognize-source-build-tradeoff} Gentoo 基于源代码的定制会带来什么取舍？
