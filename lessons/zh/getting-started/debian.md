...
1. **[Linux 快速入门](https://labex.io/zh/courses/quick-start-with-linux)** - 学习适用于多种 Linux 环境的基础知识。
2. **[软件包管理](https://labex.io/zh/courses/software-package-management)** - 练习适用于各种 Linux 环境的核心软件包管理概念。
3. **[成为初级系统管理员](https://labex.io/zh/courses/become-a-junior-system-administrator)** - 深入学习实用的 Linux 系统管理技能。
