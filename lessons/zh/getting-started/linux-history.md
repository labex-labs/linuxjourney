...
meta_keywords: "Linux 历史，UNIX, GNU 项目，Linus Torvalds, Linux kernel, Linux 初学者，Linux 教程，Linux 指南"
---

## Lesson Content

嘿，菜鸟！你决定潜入 Linux 这个精彩的世界了吗？那么，你最好系好安全带，因为这将是一条漫长而艰难的道路。我的名字是 Penguin Pete，我将在这里指导你完成这段旅程。让我们从 Linux 的一点背景故事开始吧。

要了解 Linux 是如何诞生的，让我们回到 1969 年的起点，贝尔实验室的 Ken Thompson 和 Dennis Ritchie 开发了 UNIX 操作系统。它后来用 C 语言重写，使其更具可移植性，并最终成为一个广泛使用的操作系统。
...
kernel 是操作系统的最重要组成部分。它允许硬件与软件进行通信。它还做了很多其他事情，但我们会在不同的课程中深入探讨。现在，你只需要知道 kernel 几乎控制着系统上发生的一切。
...
![Linus Torvalds 在 2018 年](https://file.labex.io/images/3e1311fd-b8ca-45e7-8d02-9aac6377bb36.jpg)
