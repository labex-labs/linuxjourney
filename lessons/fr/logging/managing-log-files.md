...
:::single-choice{#logrotate-not-backup} Pourquoi la rotation des journaux ne remplace-t-elle pas une sauvegarde ou un archivage ?
...
:::single-choice{#logrotate-rotate-seven} Que précise `rotate 7` ?
...
:::single-choice{#logrotate-open-descriptor} Pourquoi une application peut-elle avoir besoin d'un signal de réouverture après la rotation ?
...
:::single-choice{#logrotate-debug-mode} Que fournit `logrotate -d` ?
...
:::single-choice{#logrotate-journal-retention} Une règle logrotate applique-t-elle automatiquement la conservation du journal systemd ?
