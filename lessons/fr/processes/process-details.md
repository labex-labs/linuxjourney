...
:::single-choice{#process-details-program-versus-process} Qu’est-ce qui distingue deux instances en cours d’exécution du même programme ?
...
:::single-choice{#process-details-kernel-state} Quel composant conserve l’état de planification et les identifiants des processus Linux ?
...
:::single-choice{#process-details-scheduler-role} Que sélectionne l’ordonnanceur Linux ?
...
:::single-choice{#process-details-exit-status} Pourquoi un processus terminé peut-il rester brièvement sous forme de zombie ?
