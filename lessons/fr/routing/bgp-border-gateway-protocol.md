...
:::single-choice{#bgp-external-session} Qu’échange BGP externe ?
...
:::single-choice{#bgp-as-path-loop} Comment `AS_PATH` aide-t-il à prévenir les boucles entre AS ?
...
:::single-choice{#bgp-best-path-meaning} Que représente un meilleur chemin BGP ?
...
:::single-choice{#bgp-advertisement-limit} Qu’est-ce que l’annonce d’un préfixe ne garantit pas ?
...
:::single-choice{#bgp-rpki-limit} Que contrôle la validation d’origine RPKI ?
