...
:::single-choice{#ping-count-option} Que demande `-c 3` ?
...
:::single-choice{#ping-sequence-gap} Que peut indiquer l'absence d'une réponse `icmp_seq` ?
...
:::single-choice{#ping-rtt-meaning} Que mesure `time=23.7 ms` ?
...
:::single-choice{#ping-received-ttl} Qu'est-ce que le TTL affiché sur un Echo Reply IPv4 ?
...
:::single-choice{#ping-success-limit} Qu'est-ce qu'un `ping` réussi ne prouve pas ?
