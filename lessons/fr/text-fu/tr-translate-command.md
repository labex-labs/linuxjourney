...
Quelle commande retire tous les chiffres de stdin sans toucher aux autres caractères ?
...
Quelle commande réduit chaque série d'espaces ordinaires de stdin à un espace ?
...
Quelle commande fait lire `names.txt` sur stdin et convertit les minuscules en majuscules ?
