...
Quelle commande crée un répertoire nommé `documents` dans le répertoire de travail actuel ?
...
Quelle commande crée deux répertoires frères nommés `books` et `paintings` ?
...
Aucune partie de `projects/app/src` n'existe encore. Quelle commande crée le chemin complet ?
...
Quelle commande crée `public` avec le mode de permission `755` ?
