...
Vous avez lancé Bash depuis un autre shell et voulez maintenant revenir au shell parent. Quelle commande faut-il exécuter dans la session Bash imbriquée ?
...
Quelle commande termine le shell actuel en signalant explicitement une réussite à son appelant ?
...
Dans Bash, quel état `exit` renvoie-t-elle lorsqu'aucun nombre n'est fourni ?
...
Quelle commande intégrée à Bash est spécialement destinée à quitter un shell de connexion ?
