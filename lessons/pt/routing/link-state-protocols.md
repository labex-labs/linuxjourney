...
:::single-choice{#link-state-hello-limit} O que o recebimento de um hello OSPF não consegue comprovar?
...
:::single-choice{#link-state-flooding-scope} Por que as informações de estado de enlace são inundadas além de um vizinho?
...
:::single-choice{#link-state-shortest-meaning} O que “mais curto” significa em um cálculo de caminho por estado de enlace?
...
:::single-choice{#link-state-convergence-stages} O que deve ser medido durante uma investigação da convergência do OSPF?
