...
:::single-choice{#boot-bios-legacy-first-sector} O que o BIOS legado normalmente carrega primeiro do disco de boot escolhido?
...
:::single-choice{#boot-bios-uefi-esp} O que o UEFI normalmente carrega de uma Partição de Sistema EFI?
...
:::single-choice{#boot-bios-secure-boot-purpose} O que o UEFI Secure Boot impõe principalmente?
...
:::single-choice{#boot-bios-setup-key} Por que não existe uma tecla universal para entrar na configuração do firmware?
