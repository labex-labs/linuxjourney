...
:::single-choice{#sysv-overview-detection} Qual é a evidência mais forte de que o sysvinit está ativo?
...
:::single-choice{#sysv-overview-shutdown-runlevel} Qual runlevel solicita convencionalmente a parada ou o desligamento em muitos sistemas SysV?
...
:::single-choice{#sysv-overview-start-link} O que um link `S20networking` solicita convencionalmente durante a entrada em um runlevel?
...
:::single-choice{#sysv-overview-runlevel-six-meaning} O que o runlevel `6` solicita convencionalmente?
...
:::single-choice{#sysv-overview-compatibility-script} Por que um script no estilo SysV em um host com systemd normalmente deve ser invocado pelo gerenciador de serviços?
