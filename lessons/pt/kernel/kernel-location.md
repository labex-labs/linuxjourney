...
O que um arquivo versionado `vmlinuz-*` normalmente contém?
...
Por que um initramfs está ligado a uma versão do kernel e a uma configuração do sistema?
...
Qual diretório normalmente guarda módulos do kernel em execução?
...
O que uma Unified Kernel Image pode combinar?
