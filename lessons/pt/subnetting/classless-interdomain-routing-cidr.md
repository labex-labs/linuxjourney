...
:::single-choice{#cidr-prefix-meaning} O que `/24` especifica em um valor CIDR IPv4?
...
:::single-choice{#cidr-23-total} Quantos endereços IPv4 totais um `/23` contém?
...
:::single-choice{#cidr-canonical-25} Qual é a rede `/23` canônica que contém `123.12.25.0`?
...
:::single-choice{#cidr-aggregate-two-25s} Qual agregado abrange as duas metades de `192.0.2.0/24`?
...
:::single-choice{#cidr-route-specificity} Para o destino `10.42.3.8`, qual rota elegível é mais específica?
