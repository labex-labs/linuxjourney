...
:::single-choice{#boot-init-pid-one-role} PID 名前空間内の PID 1 に固有の責務はどれですか？
...
:::single-choice{#boot-init-sysv-runlevel} System V のランレベルは何を表しますか？
...
:::single-choice{#boot-init-systemd-unit-model} systemd はサービスやマウントなどの管理対象をどのように表しますか？
...
:::single-choice{#boot-init-detect-running} 従来のスクリプトディレクトリの有無より、PID 1 を調べるほうがよいのはなぜですか？
