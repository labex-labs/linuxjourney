...
Linux システムの主要部分のうち、ハードウェアを管理するものはどれですか？
...
Linux ディストリビューションを最もよく表す説明はどれですか？
...
計画された更新と予測可能性を優先する人に最適なリリース方式はどれですか？
