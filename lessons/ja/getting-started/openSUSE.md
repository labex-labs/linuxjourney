...
1. **[Linux クイックスタート](https://labex.io/ja/courses/quick-start-with-linux)** - openSUSE にも応用できる Linux の基礎を学びます。
2. **[Linux コマンドオンライン練習](https://labex.io/ja/courses/linux-basic-commands-practice-online)** - openSUSE のグラフィカルツールと並行して、コマンドライン操作に慣れましょう。
3. **[ジュニアシステム管理者になる](https://labex.io/ja/courses/become-a-junior-system-administrator)** - openSUSE のシステム管理の焦点と補完し合う、より広範な管理トピックへと進みます。
