...
1. **[Linux クイックスタート](https://labex.io/ja/courses/quick-start-with-linux)** - Debian や他の多くのディストリビューションにそのまま適用できる Linux の基礎を学びます。
2. **[ソフトウェアパッケージ管理](https://labex.io/ja/courses/software-package-management)** - Debian ベースのシステムで重要なパッケージ管理の概念を練習します。
3. **[ジュニアシステム管理者になる](https://labex.io/ja/courses/become-a-junior-system-administrator)** - Debian サーバーや安定した Linux 環境に関連する管理スキルをより深く掘り下げます。
