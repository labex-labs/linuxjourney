...
:::single-choice{#swap-space-anonymous-pages} スワップへ格納する主な候補となるメモリはどれですか？
...
:::single-choice{#swap-space-show-active} 有効なスワップ領域を構造化して一覧表示するコマンドはどれですか？
...
:::single-choice{#swap-space-enable-command} 初期化済みのスワップ領域を有効にするコマンドはどれですか？
...
:::single-choice{#swap-space-sizing-rule} スワップ容量を決める最適な基準はどれですか？
...
:::single-choice{#swap-space-swapoff-capacity} 高負荷のシステムで `swapoff` が失敗したり危険になったりするのはなぜですか？
