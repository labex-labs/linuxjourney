...
:::single-choice{#packet-analysis-interface-choice} キャプチャするインターフェースの選択が重要なのはなぜですか？
...
:::single-choice{#packet-analysis-count-bound} `-c 100` は何をしますか？
...
:::single-choice{#packet-analysis-read-file} 保存済み pcap ファイルからパケットを読むオプションはどれですか？
...
:::single-choice{#packet-analysis-no-packets} フィルター結果が空のキャプチャから、何が証明できますか？
...
:::single-choice{#packet-analysis-pcap-safety} 障害調査の pcap は、どのように扱うべきですか？
