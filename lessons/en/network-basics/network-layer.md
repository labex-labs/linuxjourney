...
:::single-choice{#network-layer-ip-service} What delivery service does IP provide by itself?
...
:::single-choice{#network-layer-prefix-decision} What helps a host decide whether an IPv4 destination is on-link?
...
:::single-choice{#network-layer-longest-prefix} Which route normally wins among eligible routes to the same destination?
...
:::single-choice{#network-layer-hop-limit} Why is TTL or Hop Limit decremented by routers?
