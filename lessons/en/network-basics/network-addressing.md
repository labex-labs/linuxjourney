...
:::single-choice{#network-addressing-mac-scope} What is the normal scope of an Ethernet MAC address in packet delivery?
...
:::single-choice{#network-addressing-ipv4-size} How large is an IPv4 address?
...
:::single-choice{#network-addressing-getent-purpose} Why use `getent ahosts` during a name-resolution check?
...
:::single-choice{#network-addressing-ip-link-versus-address} Which command view focuses on assigned IP addresses?
