...
:::single-choice{#dhcp-relay-purpose} What does a DHCP relay enable?
...
:::single-choice{#dhcp-dora-order} What is the normal initial DHCPv4 order?
...
:::single-choice{#dhcp-lease-expiration} What happens to a DHCP address lease without successful renewal?
...
:::single-choice{#dhcp-result-verification} What should be checked after a DHCP lease is accepted?
...
:::single-choice{#dhcp-ipv6-default-router} Where does an IPv6 host normally learn its default-router information?
