...
Which statement correctly describes the relationship between a terminal and a shell?
...
What does the `$` at the end of the example prompt indicate?
...
In `echo Hello World`, which part is the command name?
...
Which command makes the shell treat `Hello from Bash` as one quoted piece of text?
...
To practice these skills, explore the comprehensive [![Shell Learning Path](https://labex.io/cdn-cgi/image/width=200,height=200,quality=80,format=auto,onerror=redirect/https://file.labex.io/path/FaVTnI4iqZP0.png)Shell Learning Path](https://labex.io/learn/shell).
