...
:::single-choice{#packet-analysis-interface-choice} Why does capture-interface choice matter?
...
:::single-choice{#packet-analysis-count-bound} What does `-c 100` do?
...
:::single-choice{#packet-analysis-read-file} Which option reads packets from a saved pcap file?
...
:::single-choice{#packet-analysis-no-packets} What does an empty filtered capture prove?
...
:::single-choice{#packet-analysis-pcap-safety} How should an incident pcap be handled?
