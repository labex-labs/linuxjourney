...
:::single-choice{#dns-setup-authoritative-role} Which role publishes definitive records for zones it serves?
...
:::single-choice{#dns-setup-open-recursion} Why restrict recursive queries to authorized clients?
...
:::single-choice{#dns-setup-zone-validation-limit} What does a successful zone syntax check fail to prove?
...
:::single-choice{#dns-setup-norecurse-test} Why query an authoritative server with `+norecurse`?
...
:::single-choice{#dns-setup-redundancy-verification} What should authoritative DNS redundancy testing include?
