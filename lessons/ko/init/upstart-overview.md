...
:::single-choice{#upstart-overview-active-evidence} 호스트가 실제로 Upstart를 사용한다는 가장 강한 증거는 무엇입니까?
...
:::single-choice{#upstart-overview-start-on} Upstart `start on` 스탠자가 정의하는 것은 무엇입니까?
...
:::single-choice{#upstart-overview-event-chain} Upstart 작업 하나가 다른 작업의 시작으로 이어질 수 있는 방식은 무엇입니까?
...
:::single-choice{#upstart-overview-current-ubuntu} 현재 표준 우분투 릴리스가 사용하는 init 시스템은 무엇입니까?
