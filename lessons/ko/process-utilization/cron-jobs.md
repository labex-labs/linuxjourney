...
현재 사용자의 설치된 cron 항목을 나열하는 명령은 무엇입니까?
...
cron 명령에서 명시적인 경로와 환경 설정을 사용해야 하는 이유는 무엇입니까?
...
작업 실행 시간이 일정 간격보다 길 때 발생할 수 있는 위험은 무엇입니까?
...
일반적인 호스트별 cron이 클러스터에서 정확히 한 번 실행해야 하는 작업에 적합하지 않을 수 있는 이유는 무엇입니까?
