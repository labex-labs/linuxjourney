...
로그 로테이션이 백업이나 아카이빙을 대신할 수 없는 이유는 무엇입니까?
...
로테이션 후 애플리케이션에 다시 열기 신호가 필요할 수 있는 이유는 무엇입니까?
...
logrotate 규칙이 systemd 저널 보존을 자동으로 적용합니까?
