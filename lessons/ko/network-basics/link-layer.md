...
Ethernet 프레임 검사 시퀀스는 무엇에 사용됩니까?
...
Ethernet 스위치는 일반적으로 프레임에서 어떤 정보를 학습합니까?
...
호스트는 링크 밖의 IPv4 목적지에 어떤 MAC 주소를 사용합니까?
...
라우터에서 Ethernet 프레이밍이 바뀌는 일반적인 전달 중 무엇이 그대로 유지됩니까?
