...
:::single-choice{#osi-network-layer-number} 논리적 주소 지정과 네트워크 간 전달을 처리하는 OSI 계층은 무엇입니까?
...
:::single-choice{#osi-model-purpose} 일상적인 문제 해결에서 OSI 모델은 무엇에 가장 유용합니까?
...
:::single-choice{#osi-tcpip-mapping} OSI와 TCP/IP 계층 간 매핑은 어떻게 해석해야 합니까?
...
:::single-choice{#osi-link-success-limit} 정상적으로 작동하는 로컬 Ethernet 링크가 입증하는 것은 무엇입니까?
