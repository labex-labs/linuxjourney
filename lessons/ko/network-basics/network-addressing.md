...
:::single-choice{#network-addressing-mac-scope} 패킷 전송에서 Ethernet MAC 주소의 일반적인 범위는 무엇입니까?
...
:::single-choice{#network-addressing-ipv4-size} IPv4 주소의 크기는 얼마입니까?
...
:::single-choice{#network-addressing-getent-purpose} 이름 확인 검사에서 `getent ahosts`를 사용하는 이유는 무엇입니까?
...
:::single-choice{#network-addressing-ip-link-versus-address} 할당된 IP 주소에 초점을 맞춘 명령 보기는 무엇입니까?
