...
대상 텍스트가 `myfile`인 심볼릭 링크 `myfilelink`를 만드는 명령은 무엇입니까?
...
일반 파일 하나를 가리키는 두 하드 링크가 공유하는 것은 무엇입니까?
...
`readlink LINK`는 기본적으로 무엇을 출력합니까?
