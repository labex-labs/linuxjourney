...
파일 시스템 저널링이 충돌 후 복구하는 데 주로 도움이 되는 것은 무엇입니까?
...
같은 장치에 있는 Btrfs 스냅샷이 완전한 백업이 아닌 이유는 무엇입니까?
...
이 수업에서 대상, 소스, 유형 및 옵션과 함께 마운트된 파일 시스템을 직접 나열하는 명령은 무엇입니까?
