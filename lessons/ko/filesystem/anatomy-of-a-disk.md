...
운영체제에 디스크 파티션의 시작과 끝을 알려 주는 것은 무엇입니까?
...
MBR에서 사용 가능한 파티션을 네 개보다 많이 만들 수 있게 하는 구조는 무엇입니까?
...
파티션을 만들면 그 안에 파일 시스템도 자동으로 생성됩니까?
...
감지된 파일 시스템 콘텐츠를 파티션 테이블 방식과 구분하는 `lsblk` 필드는 무엇입니까?
