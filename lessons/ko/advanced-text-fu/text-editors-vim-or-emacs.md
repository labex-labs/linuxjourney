...
현재 쉘이 `vim`이라는 실행 파일을 해석할 수 있는지 확인하는 명령어는 무엇인가요?
...
Emacs 용어에서 방문한 파일의 편집 가능한 텍스트는 일반적으로 어디에 보관되나요?
...
익숙하지 않은 편집기를 처음 연습할 때 가장 안전한 파일은 무엇인가요?
