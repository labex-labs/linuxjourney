...
포인트를 다음 줄로 이동하는 Emacs 키는 무엇인가요?
...
포인트를 버퍼 끝으로 이동하는 Emacs 키는 무엇인가요?
...
포인트에 마크를 설정하여 영역 정의를 시작하는 키는 무엇인가요?
...
활성 영역을 제거하지 않고 킬 링에 복사하는 키는 무엇인가요?
...
가장 최근 킬 링 항목을 포인트에 삽입하는 키는 무엇인가요?
