...
1. **[리눅스 퀵 스타트](https://labex.io/ko/courses/quick-start-with-linux)** - Fedora 및 기타 배포판 전반에 적용되는 리눅스 기초를 다룹니다.
2. **[리눅스 명령어 온라인 실습](https://labex.io/ko/courses/linux-basic-commands-practice-online)** - Fedora 작업을 더 쉽게 만들어 주는 명령줄 습관을 강화합니다.
3. **[RPM 및 DNF 패키지 관리](https://labex.io/ko/courses/rpm-and-dnf-package-management)** - Fedora 와 Red Hat 계열의 핵심인 패키지 관리 도구를 연습합니다.

## Quiz Question

RHEL 은 무엇으로부터 파생되었습니까? (영어 대소문자를 구분하여 답변해 주세요.)
