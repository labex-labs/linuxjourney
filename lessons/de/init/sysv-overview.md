...
:::single-choice{#sysv-overview-detection} Was ist der stärkste Beleg dafür, dass sysvinit aktiv ist?
...
:::single-choice{#sysv-overview-shutdown-runlevel} Welches Runlevel fordert auf vielen SysV-Systemen konventionsgemäß das Anhalten oder Ausschalten an?
...
:::single-choice{#sysv-overview-start-link} Was fordert ein Link `S20networking` beim Eintritt in ein Runlevel konventionsgemäß an?
...
:::single-choice{#sysv-overview-runlevel-six-meaning} Was fordert Runlevel `6` konventionsgemäß an?
...
:::single-choice{#sysv-overview-compatibility-script} Warum sollte ein Skript im SysV-Stil auf einem systemd-Host gewöhnlich über den Dienstmanager aufgerufen werden?
