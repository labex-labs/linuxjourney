...
:::single-choice{#cidr-prefix-meaning} Was legt `/24` in einem IPv4-CIDR-Wert fest?
...
:::single-choice{#cidr-23-total} Wie viele IPv4-Adressen enthält ein `/23` insgesamt?
...
:::single-choice{#cidr-canonical-25} Was ist das kanonische `/23`-Netzwerk, das `123.12.25.0` enthält?
...
:::single-choice{#cidr-aggregate-two-25s} Welches Aggregat umfasst beide Hälften von `192.0.2.0/24`?
...
:::single-choice{#cidr-route-specificity} Welche geeignete Route ist für das Ziel `10.42.3.8` spezifischer?
