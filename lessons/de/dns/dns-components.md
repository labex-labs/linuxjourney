...
:::single-choice{#dns-components-recursive-role} Was übernimmt ein rekursiver Resolver für einen Stub-Client?
...
:::single-choice{#dns-components-authoritative-role} Wodurch ist ein Server für eine Zone autoritativ?
...
:::single-choice{#dns-components-zone-meaning} Was ist eine DNS-Zone?
...
:::single-choice{#dns-components-mx-type} Welcher Eintragstyp veröffentlicht Priorität und Hostnamen von Mail Exchangern?
...
:::single-choice{#dns-components-lower-ttl-timing} Warum sollte eine DNS-TTL lange vor einer geplanten Adressänderung abgesenkt werden?
