...
:::single-choice{#vim-insert-return-normal} Mit welcher Taste kehrst du normalerweise vom Einfügemodus in den Normalmodus zurück?
...
:::single-choice{#vim-insert-before-cursor} Welche Taste wechselt aus dem Normalmodus unmittelbar vor dem Cursor in den Einfügemodus?
...
:::single-choice{#vim-insert-first-nonblank} Welcher Befehl des Normalmodus beginnt die Eingabe vor dem ersten Zeichen der aktuellen Zeile, das kein Leerraum ist?
...
:::single-choice{#vim-append-line-end} Welcher Befehl des Normalmodus springt ans Ende der aktuellen Zeile und wechselt in den Einfügemodus?
...
:::single-choice{#vim-open-line-above} Welcher Befehl des Normalmodus öffnet über der aktuellen Zeile eine neue Zeile und wechselt in den Einfügemodus?
