...
:::single-choice{#dhcp-relay-purpose} Was ermöglicht ein DHCP-Relay?
...
:::single-choice{#dhcp-dora-order} Was ist die normale anfängliche DHCPv4-Reihenfolge?
...
:::single-choice{#dhcp-lease-expiration} Was geschieht mit einem DHCP-Adress-Lease ohne erfolgreiche Erneuerung?
...
:::single-choice{#dhcp-result-verification} Was sollte geprüft werden, nachdem ein DHCP-Lease angenommen wurde?
...
:::single-choice{#dhcp-ipv6-default-router} Woher erfährt ein IPv6-Host normalerweise seine Standardrouterinformationen?
