...
5. **Поле GECOS** - Используется для общих комментариев о пользователе или учетной записи, таких как его настоящее имя или номер телефона. Разделяется запятыми.
...
Эти лабораторные работы помогут вам применить концепции идентификаторов пользователей и управления учетными записями в реальных сценариях и обрести уверенность в администрировании пользователей Linux.
