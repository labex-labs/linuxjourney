...
:::single-choice{#setuid-lowercase-s} Что означает строчная `s` в позиции выполнения владельца?
...
:::single-choice{#setuid-effective-identity} Какой идентификатор прежде всего берётся у владельца файла, когда setuid исполняемого файла учитывается?
...
:::single-choice{#setuid-octal-value} Какое начальное восьмеричное значение обозначает специальный бит setuid?
...
:::single-choice{#setuid-nosuid-mount} Каково назначение подключения файловой системы с `nosuid`?
